...
echo Checking 'setuptools' (5/5)
python -c "import setuptools" > nul 2>&1
if %errorlevel% neq 0 (
    echo Installing setuptools...
	python -m pip uninstall -y setuptools > nul 2>&1
    python -m pip install setuptools==69.5.1 > nul
)
